...
import com.bizeng.lh.widget.switchbutton.SwitchButton;
...
public class SettingItemView extends LinearLayout {
    ...
    private int padding, paddingTop, paddingBottom, paddingStart, paddingEnd;
...
//        view.setBackgroundResource(R.drawable.selector_mine_setting_item);
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (attr) {
                    ...
                    case R.styleable.SettingItemView_item_content_text_color:
                        int color = ta.getColor(attr, 0);
                        if (color != 0) {
                            tvContent.setTextColor(color);
                        }
                        break;
                    case R.styleable.SettingItemView_item_content_text_padding:
                        padding = Math.round(ta.getDimension(attr, 0));
                        break;
                    case R.styleable.SettingItemView_item_content_text_padding_top:
                        paddingTop = Math.round(ta.getDimension(attr, 0));
                        break;
                    case R.styleable.SettingItemView_item_content_text_padding_bottom:
                        paddingBottom = Math.round(ta.getDimension(attr, 0));
                        break;
                    case R.styleable.SettingItemView_item_content_text_padding_start:
                        paddingStart = Math.round(ta.getDimension(attr, 0));
                        break;
                    case R.styleable.SettingItemView_item_content_text_padding_end:
                        paddingEnd = Math.round(ta.getDimension(attr, 0));
                        break;
                    ...
                    case R.styleable.SettingItemView_item_value_text_color:
                        int valueColor = ta.getColor(attr, 0);
                        if (valueColor != 0) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        float defHeight = getResources().getDimension(R.dimen.setting_item_def_height);
