...
public class DialogRootView extends FrameLayout {
    ...
    public DialogRootView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DialogRootView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     * @param bgRadius
     */
    public DialogRootView setBgRadius(float bgRadius){
        return setBgRadius(bgRadius, bgRadius, bgRadius, bgRadius);
    }
    public DialogRootView setBgRadius(float left_top_radius, float right_top_radius, float right_bottom_radius, float left_bottom_radius){
    ...
    private DialogRootView setBgRadius() {
        path.reset();
