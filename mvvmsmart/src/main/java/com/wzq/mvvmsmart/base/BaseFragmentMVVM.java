...
//                new ViewModelProvider.AndroidViewModelFactory(getActivity().getApplication())).get(cls);
//        return new ViewModelProvider(fragment).get(cls);
        return new ViewModelProvider(fragment, ViewModelFactory.getInstance(Utils.getApplication())).get(cls);
    }
    ...
    private void initTitle(View view) {
        if (hasToolBar()) {
            mToolbar = view.findViewById(R.id.main_bar);
